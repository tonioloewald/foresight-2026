...
- [ ] **Two out-of-book `/character-builder/` links remain dead in the ePub** (`README`/home + the auto-generated core-section TOC). The builder is web-only, so decide: drop the links from the book text, or accept them. Minor.
